...
export default function ProductCard ({
  ...
  const { colorScheme } = useColorScheme();
    return(
      <View className="w-full bg-white dark:bg-gray-50/10 rounded-3xl
      p-5 my-5">
        ...
        <TouchableOpacity className="flex-row justify-center w-10/12 
        self-center my-5 bg-black dark:bg-white rounded-full p-3">
